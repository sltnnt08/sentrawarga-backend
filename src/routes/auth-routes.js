...
authRoutes.post('/register', authRateLimiter, emailRateLimiter, validate(registerSchema), registerHandler);
...
authRoutes.post('/resend-verification-email', authRateLimiter, emailRateLimiter, validate(resendVerificationEmailSchema), resendVerificationEmailHandler);
