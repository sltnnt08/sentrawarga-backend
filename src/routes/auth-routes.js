...
import { callbackHandler, loginHandler, meHandler, registerHandler, verifyEmailHandler, resendVerificationEmailHandler, forgotPasswordHandler, resetPasswordHandler } from '../controllers/auth-controller.js';
import { authenticate } from '../middlewares/authenticate.js';
import { authRateLimiter } from '../middlewares/security.js';
import { validate } from '../middlewares/validate.js';
import { loginSchema, registerSchema, verifyEmailSchema, resendVerificationEmailSchema, forgotPasswordSchema, resetPasswordSchema } from '../validators/auth-validator.js';
