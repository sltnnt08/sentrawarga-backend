...
const schema = z.object({
	...
	sendpulseSmtpUser: z.string().min(1).optional().default(''),
	sendpulseSmtpPass: z.string().min(1).optional().default(''),
	sendpulseFromEmail: z.string().min(1).optional().default(''),
	sendpulseReplyTo: z.string().min(1).optional().default(''),
	sendpulseTestTo: z.string().min(1).optional().default(''),
